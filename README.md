...
**Human notification and approval protocol for AI agents — request permission before taking sensitive actions.**

ESCALATE.md is a plain-text Markdown file you place in the root of any AI agent project. It defines escalation triggers (deployments, external communications, financial transactions, data deletion), notification channels (email, Slack, SMS), approval methods and timeouts, context requirements, and audit logging — so critical actions pause for human review before execution.

- Full specification: [escalate.md](https://escalate.md)
- AI-readable: [llms.txt](https://escalate.md/llms.txt)
- License: MIT
...
Copy [`ESCALATE.md`](./ESCALATE.md) into your project root:
...
ESCALATE.md is part of a twelve-file open standard for AI agent safety, quality, and accountability:
